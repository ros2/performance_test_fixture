...
MimickPerformanceTest::MimickPerformanceTest()
: memory_manager(new AutoStopMemoryManager<MimickMemoryManager>())
{
}

void MimickPerformanceTest::SetUp(benchmark::State &)
{
...
void MimickPerformanceTest::TearDown(benchmark::State &)
{
  memory_manager->Pause();
}

void MimickPerformanceTest::reset_heap_counters()
{
  memory_manager->Reset();
}
